...
const galleryImages = [
  ...
  {
    src: "https://images.unsplash.com/photo-1685564551828-57240ㅇㅅㅇ76c8458?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aWxkZmxvd2VyJTIwbWVhZG93JTIwbGFuZHNjYXBlfGVufDF8fHx8MTc1ODEzNjI5OXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
        ...
        >
          ...
          {galleryImages.map((image, index) => (
            ...
            >
              ...
              <section className="relative overflow-hidden h-full"></section>
            </figure>
          ))}
        </article>
      </section>
